<nav x-data="{ open: false }" class="bg-white-border-b border-gray-100 relative" style="background-color: #DBEECB; margin-right:10px; margin-left:10px; border-radius: 10px;">
