            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <!-- <div class="p-6 text-gray-900">
                    ...
                    {{-- @if (Route::has('register'))
                        < class="mt-4">
                            <a href="{{ router') ="roundeding-1 ring-transpext-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            ister
                            </a>
                        <
                    @endif --}}
